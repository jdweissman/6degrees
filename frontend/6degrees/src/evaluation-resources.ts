...
// Categories array for wizard navigation
...
// Map category IDs to guidance data
export const categoryGuidance: Record<string, CategoryGuidance> = {
  business: {
    label: 'Business Description',
    description: 'What problem are you solving and for whom?',
    ...
    example: 'We help [target customer] solve [specific problem] by [your solution], resulting in [quantified benefit].',
    investorLens: 'Is this a real, painful problem? Is the solution 10x better than alternatives?'
  },
  market: {
    label: 'Market Analysis',
    ...
    example: 'TAM: 10,000 VC firms × $50K/year software spend = $500M. Growing at 15% annually due to AI adoption.',
    investorLens: 'Is this market large enough for VC returns? Do they understand their specific segment?'
  },
  product: {
    label: 'Product / Service',
    description: 'What have you built?',
    whatToInclude: [
      'Current product status',
      'Key features and differentiation',
      'Technology stack or approach',
      'Roadmap and defensibility'
    ],
    example: 'MVP launched Q1 2024. Core differentiation: proprietary dataset of 10K+ evaluated startups.',
    investorLens: 'Is there technical moat? How hard is this to copy?'
  },
  competition: {
    label: 'Competition',
    description: 'What is the competitive landscape?',
    whatToInclude: [
      'Direct and indirect competitors',
      'Your positioning vs alternatives',
    ...
    example: 'Alternatives: manual spreadsheets (slow, error-prone), Affinity (expensive, enterprise-focused).',
    investorLens: 'Do they understand the landscape? Is their positioning defensible?'
  },
  gtm: {
    label: 'Go-to-Market',
    description: 'How will you acquire customers?',
    whatToInclude: [
      ...
      'CAC estimates or actuals',
      'Sales process and cycle',
      'Scalable playbook'
    ],
    example: 'Primary: Direct outreach to accelerators (CAC: $500). Secondary: Content marketing, partnerships.',
    investorLens: 'Is the GTM strategy realistic? Do they understand unit economics?'
  },
  traction: {
    label: 'Traction',
    description: 'What evidence shows customers want this?',
    whatToInclude: [
    ...
    example: '$5K MRR, 10 pilot customers, 20% MoM growth, 90% retention rate.',
    investorLens: 'Is growth sustainable? Are metrics strong for this stage?'
  },
  ops: {
    label: 'Operations',
    description: 'Can you execute at this stage?',
    whatToInclude: [
    ...
    example: 'Lean team of 2 founders. Key processes: weekly customer interviews, bi-weekly product sprints.',
    investorLens: 'Can this team execute? What gaps need to be filled?'
  },
  team: {
    label: 'Management / Team',
    ...
    whatToInclude: [
      ...
      'Relevant experience or exits',
      'Key advisors',
      'Hiring plans for gaps'
    ],
    example: 'CEO: ex-VC (5 years, 20+ deals). CTO: ML engineer (ex-Google, built evaluation systems).',
    investorLens: 'Is this the right team for this problem? Track record of execution?'
  },
  finances: {
    label: 'Finances',
    description: 'What are your financial projections?',
    whatToInclude: [
      'Revenue projections (18-24 months)',
      'Key assumptions',
      'Unit economics',
      'Current runway and burn rate'
    ],
    example: 'Seeking $500K for 18 months runway. Key assumption: 10 accelerator contracts at $50K/year.',
    investorLens: 'Are projections realistic? Do they understand their unit economics?'
  },
  ask: {
    label: 'The Ask',
    description: 'What are you raising?',
    whatToInclude: [
    ...
    example: '$500K seed (SAFE). Use: 60% engineering, 30% GTM, 10% ops. Milestone: $50K MRR in 18 months.',
    investorLens: 'Is the ask appropriate for stage? Clear path to next round?'
  }
};

// Helper function to get guidance for a category
export function getGuidanceForCategory(categoryId: string): CategoryGuidance | undefined {
